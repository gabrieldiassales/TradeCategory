...
namespace TradeCategory.Test
{
    public class TradeTests
    {
        ...
        public void TestCategorizeTradeExpired()
        {
            ...
            ITrade trade = new Trade(400000, "Public", DateTime.ParseExact("07/01/2020", "MM/dd/yyyy", null));
            tradeList.Add(trade);
        ...
        public void TestCategorizeTradeHighRisk()
        {
            ...
            List<ITrade> tradeList = new List<ITrade>();
            DateTime refDate = DateTime.ParseExact("12/11/2020", "MM/dd/yyyy", null);
            ITrade trade = new Trade(2000000, "Private", DateTime.ParseExact("12/29/2025", "MM/dd/yyyy", null));
            tradeList.Add(trade);
        ...
        public void TestCategorizeTradeMediumRisk()
        {
            ...
            List<ITrade> tradeList = new List<ITrade>();
            DateTime refDate = DateTime.ParseExact("12/11/2020", "MM/dd/yyyy", null);
            ITrade trade = new Trade(5000000, "Public", DateTime.ParseExact("01/02/2024", "MM/dd/yyyy", null));
            tradeList.Add(trade);
        ...
        public void TestConvertStringToTrade()
        {
            ...
            //Act
            ITrade trade = utils.ConvertStringToTrade("5000000 Public 01/02/2024", refDate);
